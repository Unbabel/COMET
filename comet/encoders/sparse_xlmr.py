...
class SparseRobertaSelfAttention(RobertaSelfAttention):
    def __init__(self, config, position_embedding_type=None, alpha=1.0, retain_value_grad=False):
        ...
        self.retain_value_grad = retain_value_grad
    ...
    def forward(
        ...
        if not self.training and value_layer.requires_grad:
            self.value_layer = value_layer
            self.value_layer.retain_grad()
        
        if not self.training and attention_probs.requires_grad:
