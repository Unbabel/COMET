...
def run_bleurt(candidates: list, references: list, checkpoint: str = 'bleurt/bleurt-large-512'):
...
if __name__ == "__main__":
    ...
    lps = [
        'fi-en', 'gu-en','kk-en','lt-en','ru-en','zh-en', 'de-en'
    ]
    ...
    for lp in lps:
        ...
        save_to_file(f"wmt/wmt19/{lp}/{modelname}_hypothesis1.txt", scores_hyp1)
        ...
        save_to_file(f"wmt/wmt19/{lp}/{modelname}_hypothesis2.txt", scores_hyp2)
