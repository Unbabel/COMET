...
class TestSchedulers(unittest.TestCase):
    ...
    def test_warmup_constant(self):
        ...
        lrs = unwrap_schedule(self.optimizer, scheduler, self.num_steps)
        expected = [0.00025, 0.0005, 0.00075, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001]
        self.assertListEqual(lrs, expected)
    ...
    def test_linear_warmup(self):
        ...
        lrs = unwrap_schedule(self.optimizer, scheduler, self.num_steps)
        expected = [0.0005, 0.001, 0.000875, 0.00075, 0.000625, 0.0005, 0.000375, 0.00025, 0.000125, 0.0]
        self.assertListEqual(lrs, expected)